...
public final class VolumeScreen extends Screen {
    ...
    @Override public void render(GuiGraphics g,int mx,int my,float partial){
        renderBackground(g);g.fill(left,top,left+w,top+h,0xF0182028);g.fill(left,top,left+w,top+3,0xFFFFCB57);
        ...
        for(int i=offset;i<Math.min(list.size(),offset+capacity);i++){
            ...
            PlayerFaceRenderer.draw(g,info==null?DefaultPlayerSkin.getDefaultSkin(entry.id()):info.getSkinLocation(),left+17,y+10,28);
