...
public final class DiscData extends SavedData {
    ...
    public static DiscData get(MinecraftServer server) {
        return server.overworld().getDataStorage().computeIfAbsent(new SavedData.Factory<>(DiscData::new,
            (tag, provider) -> load(tag), null), "super_disc");
    }
    ...
    @Override public CompoundTag save(CompoundTag root, net.minecraft.core.HolderLookup.Provider provider) {
